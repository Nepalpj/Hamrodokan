...
const ProductDetails = () => {
  ...
  return (
    <>
    <div className=' border border-sky-500 conatiner mx-auto md:flex pr-44 flex '>
    <div className=' ml-44 border border-sky-500  py-14 w-full md:w-1/2 p-2 flex justify-center '>
      <img className='w-54 h-auto flex  border border-sky-500 ' src={product?.productImg?.url} alt={product.productName}/>
    </div>
    <div className='ml-2 border border-sky-500 w-full md:w-1/2 p-2 flex bg-gray-100 '>
      ...
      <div>
      <label className='mt-2 font-semibold   text-2xl' for="points">Qty:</label>
      <input type="number" id="points" name="points" step="1" className='border-2 rounded my-2 h-10'></input>
      </div>
      <div>
  ...
  <div className='border border-sky-500 conatiner  md:flex ml-44 py-14 mr-44 mb-5 '>
    <div className='bg-purple-950 w-full h-12 pl-3'>
